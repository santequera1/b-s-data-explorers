    ...
    <main className="bg-paper min-h-screen">
      ...
      <nav className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-border/60">
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 md:gap-2 text-sm font-semibold">
            ...
            <Link
              to="/lectura"
              className="inline-flex items-center gap-1 rounded-full bg-turquoise/15 text-institutional px-3 py-1.5 font-bold hover:bg-turquoise hover:text-white transition-colors text-xs"
            >
              <span>📖</span>
              <span>Comprensión Lectora IA</span>
            </Link>
            <Link
              to="/juegos"
        ...
        <div className="mx-auto max-w-6xl px-6 pt-10 pb-16 md:pt-16 md:pb-24 grid md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-3">
              ...
              <Link
                to="/lectura"
                className="inline-flex items-center gap-1.5 rounded-full bg-coral/10 hover:bg-coral/20 px-3.5 py-1 text-xs font-bold text-coral border border-coral/30 transition-colors"
              >
                <span>✨</span>
                <span>Nuevo: Comprensión Lectora con IA →</span>
              </Link>
            </div>
            ...
            <p className="mt-5 text-lg md:text-xl text-muted-foreground max-w-xl">
              ...
              <strong>estadística jugando</strong> junto a Bú, la búho exploradora. Recoge datos,
              constrúyelos en tablas y gráficos, y descubre el azar.
            </p>
      ...
      <section id="colegio" className="mx-auto max-w-6xl px-6 py-16 scroll-mt-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
            Somos una institución educativa oficial de <strong>Cartagena de Indias</strong>, ubicada
            en el barrio María Auxiliadora, sector Camino del Medio. Formamos niños, niñas y jóvenes
            con una oferta técnica y académica, comprometidos con una educación pública de calidad
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="card-soft p-8">
            ...
            <p className="mt-2 text-muted-foreground">
              Ofrecer una formación integral que combine el saber académico y técnico con valores
              como el respeto, la responsabilidad y la curiosidad. Creemos que cada estudiante puede
              alcanzar grandes metas cuando aprende con sentido y con alegría.
            </p>
          </div>
          <div className="card-soft p-8">
            <div className="text-3xl">💡</div>
            ...
            <p className="mt-2 text-muted-foreground">
              <strong>Exploradores de Datos</strong> es el AVA del proyecto de investigación
              desarrollado en la <strong>sede Escilda Medina Pacheco</strong>: una estrategia
              mediada por TIC, diseñada con el modelo instruccional <strong>ADDIE</strong>, que
              fortalece el pensamiento aleatorio a través del juego, la experimentación y las
              misiones.
            </p>
            <Link
              to="/proyecto"
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Exploradores de Datos convierte el <em>pensamiento aleatorio</em> del MEN en una aventura
          ilustrada. Cada semana, Bú propone un pequeño reto con animaciones, juegos y experimentos
          — para que los niños aprendan matemáticas descubriéndolas, no memorizándolas.
        </p>
      </section>
      ...
      <section id="mapa" className="mx-auto max-w-6xl px-6 py-12 scroll-mt-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
            Del diagnóstico a la meta: tres misiones de estadística (DBA 10), dos retos de azar (DBA
            11) y una insignia final.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              icon: "🔑",
              title: "Entra al aula virtual",
              body: "Con tu usuario del colegio, abres tu clase digital.",
            },
            {
              icon: "🗺️",
              title: "Descubre cada semana",
              body: "Bú te acompaña en un reto nuevo lleno de juegos.",
            },
            {
              icon: "🏅",
              title: "Gana tu insignia",
              body: "Al terminar te conviertes en un Explorador de Datos.",
            },
          ].map((step, i) => (
            <div key={i} className="card-soft p-8 text-center">
              ...
              <h3 className="font-display font-bold text-xl mt-1 text-institutional-deep">
                {step.title}
              </h3>
          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              ...
              <p className="mt-3 text-white/85 max-w-2xl">
                Recurso digital diseñado para grado <strong>3° de primaria</strong> con el modelo{" "}
                <strong>ADDIE</strong>, alineado a los Estándares Básicos de Competencias del MEN en{" "}
                <em>pensamiento aleatorio</em> y a los <strong>DBA 10 y 11</strong> de estadística.
                Pensado para integrarse al aula virtual: la plataforma administra login y
                seguimiento; Exploradores de Datos entrega la experiencia interactiva.
              </p>
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto max-w-6xl px-6 py-10 grid md:grid-cols-3 gap-6 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <p>A. Cogollo · S. Jiménez · K. Barrios · E. Dávila · L. Zamorano</p>
