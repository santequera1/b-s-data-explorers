    ...
    <main className="bg-paper min-h-screen pb-16">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-4 pb-10 text-center">
        ...
        <h1 className="mt-2 text-3xl md:text-5xl font-display font-bold text-institutional-deep leading-tight">
          Propuesta Curricular y Prototipo Funcional de{" "}
      ...
      <section className="mx-auto max-w-6xl px-6 py-8">
        <div className="card-soft p-6 md:p-8 border-2 border-emerald-300 bg-emerald-50/40 mb-10">
      ...
      <section className="mx-auto max-w-6xl px-6 py-6">
        ...
        <div className="space-y-4">
          {fasesCurriculares.map((f) => (
            <div
              key={f.num}
              className="card-soft p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-l-4 border-l-turquoise"
            >
              <div className="flex items-start gap-4">
                <span className="w-12 h-12 rounded-2xl bg-paper border border-border grid place-items-center text-2xl shrink-0">
                  {f.icon}
                </span>
                <div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {consideracionesEticas.map((e, idx) => (
            <div key={idx} className="card-soft p-5 flex items-start gap-3">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        <div className="card-soft p-8 text-center border-2 border-institutional/20">
          <p className="text-xs font-bold tracking-widest uppercase text-turquoise">
            Equipo Investigador y Docente
          </p>
          <h2 className="mt-1 text-2xl font-display font-bold text-institutional-deep">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            {[
              ...
              <span
                key={n}
                className="rounded-full bg-institutional/10 border border-institutional/15 px-4 py-1.5 text-xs md:text-sm font-bold text-institutional-deep"
              >
                {n}
              </span>
            ))}
