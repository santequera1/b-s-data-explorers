...
const estandares = [
  {
    icon: "🗂️",
    t: "Clasificar y organizar datos de acuerdo a cualidades y atributos y presentarlos en tablas.",
  },
  {
    icon: "💬",
    t: "Interpretar cualitativamente datos referidos a situaciones del entorno escolar.",
  },
  { icon: "📖", t: "Describir situaciones o eventos a partir de un conjunto de datos." },
  {
    icon: "📊",
    t: "Representar datos relativos al entorno usando objetos concretos, pictogramas y diagramas de barras.",
  },
  { icon: "🔁", t: "Identificar regularidades y tendencias en un conjunto de datos." },
  {
    icon: "⚖️",
    t: "Explicar, desde la experiencia, la posibilidad o imposibilidad de ocurrencia de eventos cotidianos.",
  },
  {
    icon: "🔮",
    t: "Predecir si la posibilidad de ocurrencia de un evento es mayor que la de otro.",
  },
  {
    icon: "🧩",
    t: "Resolver y formular preguntas que requieran coleccionar y analizar datos del entorno próximo.",
  },
];
...
const hallazgos = [
  {
    valor: "80%",
    label: "Dominio del conteo y la organización básica de datos",
    tipo: "fortaleza",
  },
  {
    valor: "76%",
    label: "Acierto comparando ruletas: el pensamiento visual es su mayor fortaleza",
    tipo: "fortaleza",
  },
  {
    valor: "75%",
    label: "Interpretación de tablas de frecuencia ya construidas",
    tipo: "fortaleza",
  },
  {
    valor: "52%",
    label: "Noción de probabilidad (eventos seguros, posibles e imposibles)",
    tipo: "reto",
  },
  { valor: "39%", label: "Construcción autónoma de gráficas de barras", tipo: "reto" },
  {
    valor: "20%",
    label: "Pictogramas con escala (comprender que un símbolo vale varias unidades)",
    tipo: "reto",
  },
];
    ...
    <main className="bg-paper min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-4 pb-10 text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          <strong>Exploradores de Datos</strong> es el Entorno Virtual de Aprendizaje del proyecto{" "}
          <em>
            «Estrategia Pedagógica Mediada por las TIC para el Fortalecimiento del Pensamiento
            Aleatorio en Estudiantes de Grado 3° de la Institución Educativa Ciudad de Tunja, Sede
            Escilda Medina Pacheco»
          </em>{" "}
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="card-soft p-6 bg-gradient-to-br from-institutional to-institutional-deep text-white">
            ...
            <p className="mt-2 text-sm text-white/85">
              Este marco sistemático garantiza que la plataforma sea coherente, esté alineada con
              los referentes de calidad del MEN (EBC y DBA) y responda directamente a las
              necesidades detectadas en el diagnóstico — no a la improvisación.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground max-w-3xl mx-auto">
          💡 La brecha entre organizar datos (80%) y construirlos gráficamente (39%) justifica la
          mediación TIC: el software asume la carga procedimental del dibujo para que el niño se
          concentre en el <strong>análisis</strong>. Por eso las misiones de este AVA priorizan
          pictogramas con escala y construcción guiada de gráficas.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-muted-foreground">Pensamiento aleatorio y sistemas de datos:</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="card-soft p-7 border-t-4 border-t-coral">
            ...
            <p className="mt-3 text-institutional-deep font-medium">
              ...
              una escala cualitativa (mayor, menor e igual).»
            </p>
            <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
              <li>
                ✅ Usar la escala: imposible, menos posible, igualmente posible, más posible,
                seguro.
              </li>
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        <div className="card-soft p-8 md:p-10">
          ...
          <p className="mt-5 text-center text-sm text-muted-foreground">
            Asesor: <strong>Raúl Ernesto Acosta Mesa</strong> · Cartagena de Indias, Bolívar · 2026
          </p>
